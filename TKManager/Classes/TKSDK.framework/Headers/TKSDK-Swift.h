...
#ifndef TKSDK_SWIFT_H
#define TKSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TKSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5TKSDK13BalloonMarker")
...
SWIFT_CLASS("_TtC5TKSDK12XYMarkerView")
